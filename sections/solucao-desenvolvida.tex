...
\textcolor{red}{parei em Skeleton tracking with the Kinect SDK. %vamos adicionar os joints que sao utilizados (seated mode); "Start tracking skeleton joints", "Get Kinect running and instantiate skeleton
%tracking", "Enabling and disabling the skeleton stream", "Processing the skeleton frames"
}
